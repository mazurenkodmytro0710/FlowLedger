...
export default function AnalyticsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] pb-32" onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd}>
      ...
      {selectedCategory && (
        <button onClick={() => setSelectedCategory(null)} className="mx-4 mb-3 flex items-center gap-2 text-sm text-[#6b7280]">
        ...
        <>
          ...
          <div className="mx-4 mt-4 space-y-1">
            {visibleBreakdown.map((item, index) => (
              ...
              >
                <div className="h-3 w-3 shrink-0 rounded-full" style={{ backgroundColor: CHART_COLORS[index % CHART_COLORS.length] }} />
